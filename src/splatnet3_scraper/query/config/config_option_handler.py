...
class ConfigOptionHandler:
    ...
    _BASE_OPTIONS: tuple[ConfigOption, ...] = (
        ...
        ConfigOption[str](
            ...
            default=None,
            section="options",
            env_var=APP_VERSION_OVERRIDE_ENV,
            apply_prefix=False,
        ),
        ...
        ConfigOption[str](
            name="nxapi_client_id",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ID_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_secret",
            default=None,
            section="nxapi",
            deprecated_names=["nxapi_shared_secret"],
            env_var=NXAPI_CLIENT_SECRET_ENV,
            env_var_aliases=NXAPI_CLIENT_SECRET_ENV_ALIASES,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_assertion",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ASSERTION_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_assertion_private_key_path",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ASSERTION_PRIVATE_KEY_PATH_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_assertion_jku",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ASSERTION_JKU_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_assertion_kid",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ASSERTION_KID_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_assertion_type",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_ASSERTION_TYPE_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_scope",
            default=NXAPI_DEFAULT_AUTH_SCOPE,
            section="nxapi",
            env_var=NXAPI_SCOPE_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_user_agent",
            default=None,
            section="nxapi",
            env_var=NXAPI_USER_AGENT_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_client_version",
            default=None,
            section="nxapi",
            env_var=NXAPI_CLIENT_VERSION_ENV,
            apply_prefix=False,
        ),
        ConfigOption[str](
            name="nxapi_token_url",
            default=NXAPI_AUTH_TOKEN_URL,
            section="nxapi",
            env_var=NXAPI_AUTH_TOKEN_URL_ENV,
            apply_prefix=False,
        ),
    )
